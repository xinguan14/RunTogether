...
public abstract class ParentWithNaviActivity extends BaseActivity {
    ...
    public void initNaviView(){
        tv_title = getView(com.xinguan14.jdyp.R.id.tv_title);
        tv_right = getView(com.xinguan14.jdyp.R.id.tv_right);
        tv_left = getView(com.xinguan14.jdyp.R.id.tv_left);
    ...
    View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case com.xinguan14.jdyp.R.id.tv_left:
                    if (listener == null)
                        finish();
                    else{
                        listener.clickLeft();
                    ...
                    break;
                case com.xinguan14.jdyp.R.id.tv_right:
                    if (listener != null)
                        listener.clickRight();
                    break;
    ...
    protected void refreshTop() {
        setLeftView(left()==null ? com.xinguan14.jdyp.R.drawable.base_action_bar_back_bg_selector: left());
        setValue(com.xinguan14.jdyp.R.id.tv_right, right());
    ...
    private void setLeftView(Object obj){
        if(obj !=null && !obj.equals("")){
            ...
            if(obj instanceof Integer){
                ...
                tv_left.setImageResource(com.xinguan14.jdyp.R.drawable.base_action_bar_back_bg_selector);
            }
        }else{
