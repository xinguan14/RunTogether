...
public class ReceiveImageHolder extends BaseViewHolder {
  ...
  @Bind(com.xinguan14.jdyp.R.id.iv_avatar)
  protected ImageView iv_avatar;

  @Bind(com.xinguan14.jdyp.R.id.tv_time)
  protected TextView tv_time;

  @Bind(com.xinguan14.jdyp.R.id.iv_picture)
  protected ImageView iv_picture;
  @Bind(com.xinguan14.jdyp.R.id.progress_load)
  protected ProgressBar progress_load;

  public ReceiveImageHolder(Context context, ViewGroup root,OnRecyclerViewListener onRecyclerViewListener) {
    super(context, root, com.xinguan14.jdyp.R.layout.item_chat_received_image,onRecyclerViewListener);
  }
  ...
  public void bindData(Object o) {
    ...
    //显示图片
    ImageLoaderFactory.getLoader().load(iv_picture,message.getRemoteUrl(),  com.xinguan14.jdyp.R.mipmap.ic_launcher,new ImageLoadingListener(){;
