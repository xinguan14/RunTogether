...
import com.xinguan14.jdyp.task.BCountTask;
import com.xinguan14.jdyp.task.BFindTask;
import com.xinguan14.jdyp.task.BQuery;
import com.xinguan14.jdyp.task.BRequest;
import com.xinguan14.jdyp.task.BTable;
...
//						BmobLog.i("deleteBlackRelation onSuccess");
	...
	*//** 删除黑名单关联关系：
	...
	/** 查询指定范围内的用户人数,可以添加额外查询条件
	  ...
	  * @param  latitude：纬度
	  * @param  isShowFriends：是否显示附近的好友
	  * @param  equalProperty：自己定义的其他属性使用方法AddWhereEqualTo对应的属性名称
	  * @param  equalObj：查询equalProperty属性对应的属性值
	  * @param  countCallback ：个数回调
	  * @return 
	  * @throws
